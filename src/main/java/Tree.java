...
public class Tree {
    ...
    private static ArrayList<String> traverse(Node node, ArrayList<String> labels) {
        for (int i = 0; i < node.getChildNodes().size(); i++) {
            labels = traverse(node.getChildNodes().get(i), labels);
        }
    ...
    public static void main(String[] args) throws IOException {
        Tree tree1 = new Tree("C:/Users/Elizabeth Jiang/workspace/newproject/src/newproject/Test1.java");
        Tree tree2 = new Tree("C:/Users/Elizabeth Jiang/workspace/newproject/src/newproject/Test2.java");
